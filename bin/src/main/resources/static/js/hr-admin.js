window.onload = function () {
	...
	// ----------------- 조회단위 일/주/월 버튼 
	let dayFilterBtn = document.querySelector('#filter-day');
	let weekFilterBtn = document.querySelector('#filter-week');
	let monthFilterBtn = document.querySelector('#filter-month');

	function termFilterToggleListener() {
		dayFilterBtn.classList.remove("selected")
		weekFilterBtn.classList.remove("selected")
		monthFilterBtn.classList.remove("selected")
		this.classList.add("selected");
	}

	dayFilterBtn.addEventListener("click", termFilterToggleListener)
	weekFilterBtn.addEventListener("click", termFilterToggleListener)
	monthFilterBtn.addEventListener("click", termFilterToggleListener)
